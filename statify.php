...
dir::copy(__DIR__ . DS . 'assets',  __DIR__ . DS . $folder . DS . 'assets');
dir::copy(__DIR__ . DS . 'content', __DIR__ . DS . $folder . DS . 'content');
...
foreach($site->index() as $page) {
  ...
  if($page->isHomePage()) {
    $root = __DIR__ . DS . $folder . DS . 'index.html';
  } else {
    $root = __DIR__ . DS . $folder . DS . $page->uri() . DS . 'index.html';
  }
...
Your site has been exported to the <b><?php echo $folder; ?></b> folder.<br />
