...
},t,o?r:void 0,o,null)}})}),it.fn.size=function(){return this.length},it.fn.andSelf=it.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return it});var or=e.jQuery,ar=e.$;return it.noConflict=function(t){return e.$===it&&(e.$=ar),t&&e.jQuery===it&&(e.jQuery=or),it},typeof t===Ct&&(e.jQuery=e.$=it),it}),$(function(){$("#toggleMainNav").on("click",function(){$("body").toggleClass("js-showMainNav"),$(this).toggleClass("active")}),$(".Question-header").on("click",function(){$(this).parent().find(".Question-content").slideToggle(200)})});